...
// This is the most optimal search algorithm. But only use this when the array elements are guarateed to be sorted.
// The binary search will take only O(log n) in worse case and O(1) in best case.
