...
//    private static final Logger logger = LoggerFactory.getLogger(StudentService.class);
    ...
    public String addStudent(Student newStudent){
        ...
        System.out.println(savedStudent.getStudentName());
        System.out.println(savedStudent.getStudentAge());
        log.info("Added the student successfully, student name: {}",newStudent.getStudentName());
        return "Student added successfully";
    }

    public List<Student> getStudents(){
        List<Student> students = studentRepository.findAll();
        log.debug("Fetch all students from database");
        return students;
    }
...
//    }
    ...
    public String calculateGrade(Integer mark){
        ...
        if(mark < 0 || mark > 100){
            log.error("Invalid mark received: {}",mark);
